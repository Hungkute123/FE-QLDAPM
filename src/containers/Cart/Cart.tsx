                                                        ...
                                                        <div className="checkout-type-button-cart" style={{ alignContent: "center" }}>
                                                            <div className="method-button-cart">
                                                                {user.isAccount ?
                                                                    ...
                                                                    :
                                                                    <Button title="Thanh toán" className="button btn-proceed-checkout btn-checkout" onMouseEnter={handleOnEnter} onMouseLeave={handleOnLeave} onClick={() => setIsOpen(true)}>
                                                                        <span>
                                                                            <span>Thanh toán</span>
                                                                        </span>
